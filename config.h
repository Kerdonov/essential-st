...
/* default TERM value */
char *termname = "Kert's awesome st";
...
static Shortcut shortcuts[] = {
  ...
  { ACMPL_MOD,            XK_W,           autocomplete,   { .i = ACMPL_WORD        } },
  { ACMPL_MOD,            XK_period,      autocomplete,   { .i = ACMPL_FUZZY_WORD  } },
  { ACMPL_MOD,            XK_comma,       autocomplete,   { .i = ACMPL_FUZZY       } },
  { ACMPL_MOD,            XK_X,           autocomplete,   { .i = ACMPL_SUFFIX      } },
  { ACMPL_MOD,            XK_S,           autocomplete,   { .i = ACMPL_SURROUND    } },
